...
class AIEngine:
    ...
    def refresh_prompts(self):
        ...
        self.system_prompt = (
            "You are Carran AI, the world's most capable autonomous AI agent. "
    ...
    async def generate_response(self, messages: List[Dict[str, str]], proxy: Optional[str] = None, cookies: Optional[str] = None) -> str:
        ...
        for provider in unique_providers:
            try:
                logging.info(f"Carran Engine: Attempting {provider.__name__} (g4f)")
                ...
                logging.error(f"Carran Engine: {provider.__name__} (g4f) failed: {e}")
                continue
